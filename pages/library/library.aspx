...
=======
    ...
    <asp:Panel runat="server" CssClass="PersoDataPopup" Height="980px" Width="973px" ScrollBars="Vertical">
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Neu" />
        <b>
            <asp:CheckBox ID="CBFilter" runat="server" AutoPostBack="true" Text="ausgeliehen" />
            <br />
        </b>
        <table class="nav-justified" border="0">
            <tr>
                ...
                <td>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:toolboxConnectionString %>" DeleteCommand="DELETE FROM [Books] WHERE [Id] = @original_Id AND (([titel] = @original_titel) OR ([titel] IS NULL AND @original_titel IS NULL)) AND (([author] = @original_author) OR ([author] IS NULL AND @original_author IS NULL)) AND (([booknr] = @original_booknr) OR ([booknr] IS NULL AND @original_booknr IS NULL)) AND (([location] = @original_location) OR ([location] IS NULL AND @original_location IS NULL)) AND (([description] = @original_description) OR ([description] IS NULL AND @original_description IS NULL)) AND (([numberOfCopies] = @original_numberOfCopies) OR ([numberOfCopies] IS NULL AND @original_numberOfCopies IS NULL)) AND (([nrOfPages] = @original_nrOfPages) OR ([nrOfPages] IS NULL AND @original_nrOfPages IS NULL)) AND (([yearpublished] = @original_yearpublished) OR ([yearpublished] IS NULL AND @original_yearpublished IS NULL)) AND (([picture] = @original_picture) OR ([picture] IS NULL AND @original_picture IS NULL)) AND (([publisher] = @original_publisher) OR ([publisher] IS NULL AND @original_publisher IS NULL)) AND (([checkedOut] = @original_checkedOut) OR ([checkedOut] IS NULL AND @original_checkedOut IS NULL)) AND (([lent] = @original_lent) OR ([lent] IS NULL AND @original_lent IS NULL))" InsertCommand="INSERT INTO [Books] ([titel], [author], [booknr], [location], [description], [numberOfCopies], [nrOfPages], [yearpublished], [picture], [publisher], [checkedOut], [lent]) VALUES (@titel, @author, @booknr, @location, @description, @numberOfCopies, @nrOfPages, @yearpublished, @picture, @publisher, @checkedOut, @lent)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT Books.Id, Books.titel, Books.author, Books.booknr, Books.location, Books.description, Books.numberOfCopies, Books.nrOfPages, Books.yearpublished, Books.picture, Books.publisher, Books.checkedOut, Books.lent, Abteilungen.Abteilungsnummer, Abteilungen.Abteilung, Books.picture AS Expr1 FROM Books INNER JOIN Abteilungen ON Books.location = Abteilungen.Abteilungsnummer WHERE (Books.Id = @Id) AND (Books.lent = @lent)" UpdateCommand="UPDATE [Books] SET [titel] = @titel, [author] = @author, [booknr] = @booknr, [location] = @location, [description] = @description, [numberOfCopies] = @numberOfCopies, [nrOfPages] = @nrOfPages, [yearpublished] = @yearpublished, [picture] = @picture, [publisher] = @publisher, [checkedOut] = @checkedOut, [lent] = @lent WHERE [Id] = @original_Id ">
                        <DeleteParameters>
                            <asp:Parameter Name="original_Id" Type="Int32" />
                            <asp:Parameter Name="original_titel" Type="String" />
                            <asp:Parameter Name="original_author" Type="String" />
                        ...
                        <InsertParameters>
                            ...
                            <asp:Parameter Name="nrOfPages" Type="Int32" />
                            <asp:Parameter Name="yearpublished" Type="String" />
                            <asp:Parameter Name="picture" Type="String" DefaultValue="generic.jpg" />
                            <asp:Parameter Name="publisher" Type="String" />
                        ...
                        <SelectParameters>
                            <asp:ControlParameter ControlID="GridView1" Name="Id" PropertyName="SelectedValue" Type="Int32" />
                            <asp:SessionParameter DefaultValue="False" Name="lent" SessionField="Lent" />
                        </SelectParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="titel" Type="String" />
                            <asp:Parameter Name="author" Type="String" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:toolboxConnectionString %>" SelectCommand="SELECT * FROM [Personal]"></asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:toolboxConnectionString %>" SelectCommand="SELECT [id], [Abteilungsnummer], [Abteilung] FROM [Abteilungen]"></asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:toolboxConnectionString %>" SelectCommand="SELECT Books.Id, Books.titel, Books.author, Books.booknr, Books.location, Books.description, Books.numberOfCopies, Books.nrOfPages, Books.yearpublished, Books.checkedOut, Books.lent, Books.picture, Books.publisher, Abteilungen.Abteilungsnummer, Abteilungen.Abteilung FROM Books INNER JOIN Abteilungen ON Books.location = Abteilungen.Abteilungsnummer WHERE (Books.titel LIKE '%' + @titel + '%') AND (Books.lent = @lent)">
                        <SelectParameters>
                            <asp:SessionParameter Name="titel" SessionField="sqlSearch" Type="String" />
                            <asp:SessionParameter Name="lent" SessionField="lent" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td style="top: auto; vertical-align: top; width: 463px;">&nbsp;
                           

                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource4" ForeColor="#333333" GridLines="None" AllowSorting="True">
                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                        <Columns>
                                            <asp:CommandField ShowSelectButton="True" />
                                            <asp:BoundField DataField="id" HeaderText="ID" SortExpression="ID" />
                ...
                <td style="top: auto; vertical-align: top; width: 60px;">&nbsp;</td>
                <td>&nbsp;
>>>>>>> origin/master
...
>>>>>>> origin/master
                                            ...
                                            <tr>
                                                <td style="width: 161px"><b>Buchnr</b></td>
                                            ...
                                            <tr>
                                                <td style="width: 161px"><b>Titel</b></td>
                                                <td style="width: 148px" colspan="2">
                                            ...
                                            <tr>
                                                <td style="width: 161px"><b>Author</b></td>
                                                <td style="width: 148px" colspan="2">
...
=======
                                                <td style="height: 24px; width: 161px;"><b>Herausgeber</b></td>
                                                <td style="height: 24px; width: 148px;" colspan="2">
...
=======
                                                ...
                                                <td>&nbsp;</td>
                                                <td>
                                                    <asp:FileUpload ID="FileUpload2" runat="server" Height="19px" Width="329px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="width: 30px">&nbsp;</td>
                                                <td colspan="2">&nbsp;</td>
                                                <td><b>Bild<asp:Button ID="UploadButton" runat="server" Height="23px" OnClick="UploadButton_Click" Text="Upload" Width="58px" />
                                                    <asp:Label ID="StatusLabel" runat="server"></asp:Label>
>>>>>>> origin/master
                                                </b></td>
                                            </tr>
                                            <tr>
                                                <td style="width: 161px"><b>Veröffentlichungsjahr</b></td>
                                                <td style="width: 148px" colspan="2">
...
=======
                                                    <asp:Image ID="Image3" runat="server" ImageUrl='<%# Bind("picture")%>' />
>>>>>>> origin/master
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="height: 24px; width: 161px;"><b>Kopien</b></td>
                                                <td style="height: 24px; width: 148px;" colspan="2">
                                                    <b>
                                            ...
                                            <tr>
                                                <td style="width: 161px;"><b>Standort</b></td>
                                                <td style="width: 148px;" colspan="2">
                                                    <b>
                                                        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource3" DataTextField="Abteilung" DataValueField="id" SelectedValue='<%# Bind("Location") %>'>
                                                        </asp:DropDownList>
...
=======
                                                <td style="height: 34px; width: 161px;">&nbsp;</td>
                                                <td style="height: 34px; width: 148px" colspan="2">&nbsp;</td>
>>>>>>> origin/master
...
<<<<<<< HEAD
                                                <td style="height: 34px; width: 148px"><b>
=======
                                                <td style="height: 34px; width: 148px" colspan="2"><b>
>>>>>>> origin/master
                            ...
                            <asp:TextBox ID="tbpic1" runat="server" Text='<%# Bind("picture") %>' Visible="false"></asp:TextBox>
                            <br />
...
=======
                                        <asp:Image ID="Image2" runat="server" ImageUrl='<%# Bind("picture")%>' Height="200px" />
>>>>>>> origin/master
                                    </td>
                                </tr>
                                <tr>
